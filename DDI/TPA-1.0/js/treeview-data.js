		...
		{title: "Library A", key: "id4", expand: true, unselectable: true,
			children: [
				{title: "Domain A", expand: true,
					children: [
						{title: "Account Management", key: "id4.1.1", expand: true,
							children: [
						...
						{title: "Active Learning", key: "id4.1.2", expand: true,
							children: [
				...
				{title: "Domain B", expand: true,
					children: [
						{title: "Assignment Management", key: "id4.2.1", expand: true,
							children: [
						...
						{title: "Becoming a Business Advisor", key: "id4.2.2", expand: true,
							children: [
...
//				{title: "Domain A", expand: true,
//					children: [
//						{title: "Assignment Management", key: "id4.1.1", expand: true,
//							children: [
//							{title: "Balances sales funnel", key: "id4.1.1.1" },
//							{title: "Prioritizes own activities", key: "id4.1.1.2" },
//							{title: "Schedules", key: "id4.1.1.3" }
